...
<form  class="form-horizontal" name="addBatchForm" method="post" action="<c:url value="/addTerm" />" >
	...
	<div class="form-group">
		<label for="termCode" class="col-sm-2 control-label">Term ID *</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" id="termCode" name="termCode"
				placeholder="Term ID">
		</div>
	</div>
