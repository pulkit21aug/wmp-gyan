...
<form  class="form-horizontal" name="addBatchForm" method="post" action="<c:url value="/addSubject" />" >
   ...
   <div class="form-group">
		<label for="subCode" class="col-sm-2 control-label">Subject Code</label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="subName" class="col-sm-2 control-label">Subject Name</label>
		<div class="col-sm-8">
